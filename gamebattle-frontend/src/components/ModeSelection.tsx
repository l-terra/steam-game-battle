  ...
  return (
      <div className="flex min-h-screen items-center justify-center px-6">
        <div className="w-full max-w-3xl">
          ...
          {/* Grid com os modos Batalha e Aleatório */}
          ...
          <motion.button
              ...
              className="mx-auto block mt-6 w-full max-w-2xl rounded-xl border border-border bg-card/30 p-4 text-center font-display text-lg font-bold text-muted-foreground transition-all hover:border-yellow-500/50 hover:bg-yellow-500/10 hover:text-yellow-500"
          >
